...
public class Set extends BNCommand {
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if(args.length == 2 ? Api.setMoney(args[0], amount) : Api.setMoney(args[0], amount, Api.getEconKey(args[2]))) {			sender.sendMessage(args[0]+" balance was set to "+Api.formatMoney(Double.parseDouble(args[1])));
		}else{
